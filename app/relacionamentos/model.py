...
association_user_rel = db.Table('association_user_rel', db.Model.metadata,
...
class Relacionamento(BaseModel): 
    ...
    user = db.relationship("User", secondary=association_user_rel, back_populates="relacionamento")
